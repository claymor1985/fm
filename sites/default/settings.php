 ...
 *
 */
$drupal_hash_salt = 'ePyLfYlLzGLcKVhaWQs-sYmwzWEtX5E237PrgOrol4E';
...
if (file_exists('/var/www/local/fm/local.settings.php')) {
  require('/var/www/local/fm/local.settings.php');
}
